<audio title="09 _ 让我们揭开WebRTC建立连接的神秘面纱" src="https://static001.geekbang.org/resource/audio/b7/b8/b7ff922d81efdcaef3bec6f31bc365b8.mp3" controls="controls"></audio> 
<p><span class="reference"></span>在上一篇<a href="https://time.geekbang.org/column/article/111675">《08 | 有话好商量，论媒体协商》</a>文章中，我向你介绍了WebRTC进行通信时，是如何进行媒体协商的，以及媒体协商的目的是什么。</p><p>在媒体协商过程中，如果双方能达成一致，也就是商量好了使用什么编解码器，确认了使用什么传输协议，那么接下来，WebRTC就要建立连接，开始传输音视频数据了。</p><p>WebRTC之间建立连接的过程是非常复杂的。之所以复杂，主要的原因在于它既要考虑传输的<strong>高效性</strong>，又要保证端与端之间的<strong>连通率</strong>。</p><p>换句话说，当同时存在多个有效连接时，它首先选择传输质量最好的线路，如能用内网连通就不用公网。另外，如果尝试了很多线路都连通不了，那么它还会使用服务端中继的方式让双方连通，总之，是“想尽办法，用尽手段”让双方连通。</p><p>对于<strong>传输的效率与连通率</strong>这一点，既是WebRTC的目标，也是 WebRTC 建立连接的基本策略。下面我们就来具体看一下 WebRTC 是如何达到这个目标的吧！</p><h2>在WebRTC 处理过程中的位置</h2><p>下面这张图清晰地表达了本文所讲的内容在整个WebRTC处理过程中的位置。</p><p><img src="https://static001.geekbang.org/resource/image/fb/ff/fbce1bba75073ab721cca628b0a61cff.png" alt=""></p><center><span class="reference">WebRTC处理过程图</span></center><p>图中的红色部分——连接的创建、STUN/TURN以及 NAT 穿越，就是我们本文要讲的主要内容。</p><h2>连接建立的基本原则</h2><!-- [[[read_end]]] --><p>接下来，我将通过两个具体的场景，向你介绍一下 WebRTC 建立连接的基本原则。不过在讲解之前，我们先设置一些假设条件，这样会更有利于我们下面的描述：</p><ul>
