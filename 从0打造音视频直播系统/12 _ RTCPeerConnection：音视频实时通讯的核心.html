<audio title="12 _ RTCPeerConnection：音视频实时通讯的核心" src="https://static001.geekbang.org/resource/audio/f2/ee/f241def49f86e98fa1adc497349ee5ee.mp3" controls="controls"></audio> 
<p>RTCPeerConnection 类是在浏览器下使用 WebRTC 实现1对1实时互动音视频系统最核心的类。你可以认为它是一个总的接口类或者称它为聚合类，而该类中实现的很多功能都是由其他类具体实现的。</p><p>像我前面讲的很多文章，都是 RTCPeerConnection 类的一部分功能，如 ：</p><ul>
